...
namespace AT.Character.Condition {
	...
	public class Shocked : DurationCondition {
		
		public Shocked(int duration=1, TickType tickType=TickType.TURN_BEGIN, Sheet tickHost=null) : base(duration, tickType, tickHost) {
